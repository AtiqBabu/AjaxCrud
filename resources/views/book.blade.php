            ...
            <div class="modal-body">
                <form id="bookForm" name="bookForm" class="form-horizontal">
                   <input type="hidden" name="book_id" id="book_id">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Editor</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="editor" name="editor" placeholder="Enter Editor" value="" maxlength="50" required="">
                        </div>
                    </div>
